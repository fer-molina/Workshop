<#macro registrationLayout displayInfo=false displayMessage=false displayRequiredFields=false>
  <!DOCTYPE html>
  <html <#if realm.internationalizationEnabled> lang="${locale.currentLanguageTag}" dir="${(locale.rtl)?then('rtl','ltr')}"</#if>>
    <head>
      ...
      <script type="text/javascript" src="${apiUrl}/v1/lm-tecnologias-interactivas/hub-mfa-auth-ui/${cms_env}/env-config.js?v=${dateHash}"></script>
      <script type="text/javascript" src="${apiUrl}/v1/lm-tecnologias-interactivas/hub-mfa-auth-ui/${cms_env}/hub-mfa-auth-ui.js?v=${dateHash}"></script>
      <link rel="stylesheet" href="${apiUrl}/v1/lm-tecnologias-interactivas/hub-mfa-auth-ui/${cms_env}/hub-mfa-auth-ui.css?v=${dateHash}" />
    </head>
    <body>
      <#nested "form">
    </body>
